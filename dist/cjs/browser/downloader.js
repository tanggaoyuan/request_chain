...
class Downloader {
    ...
    startPart(part_1) {
        return __awaiter(this, arguments, void 0, function* (part, data = {}) {
            ...
            const params = Object.assign(Object.assign({}, this.config), { params: Object.assign(Object.assign({}, this.config.data), data), headers: Object.assign(Object.assign({}, this.config.headers), { Range: `bytes=${part_info.start}-${part_info.end}`, 
