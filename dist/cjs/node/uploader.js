...
class Uploader {
    constructor(options) {
        ...
        const stat = fs_1.default.statSync(options.file_path);
        const name = path_1.default.basename(options.file_path);
        const file = {
            size: stat.size,
            name,
        ...
        this.file = file;
        const { request, part_size = 0, url, concurrent = 1, md5_thread = -1, checkpart, } = options;
    ...
    readFileRange(start, end) {
        try {
            const readStream = fs_1.default.createReadStream(this.file.path, { start, end });
            const chunks = [];
    ...
    getMd5(part, thread) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const buffer = yield this.readFileRange(start, end);
            return thread ? (0, md5_1.getMd5Thread)(buffer) : (0, md5_1.getMd5)(buffer);
        });
    }
    /**
    ...
    startPart(part_1) {
        return __awaiter(this, arguments, void 0, function* (part, data = {}) {
            ...
            const chunk = fs_1.default.createReadStream(this.file.path, {
                start: part_info.start,
                end: part_info.end,
            });
            const task = this.request(Object.assign(Object.assign({}, this.config), { data: Object.assign(Object.assign(Object.assign(Object.assign({}, part_info), this.config.data), data), { [this.name]: chunk }), onUploadProgress: (value) => {
                    this.progress[part] = {
