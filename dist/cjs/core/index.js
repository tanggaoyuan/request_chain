        ...
        this.promise = new Promise((resolve, reject) => {
            setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    const urlParams = Object.assign(Object.assign({}, qs_1.default.parse(query)), this.config.params);
                    url = host + "?" + qs_1.default.stringify(urlParams);
                    let key = "";
                    if (!!cache || mergeSame) {
                        key = `${this.config.method}${host}(${this.serializeParams(urlParams)})(${this.serializeParams(this.config.data)})`;
                        const md5 = new spark_md5_1.default();
                        md5.append(key);
                        key = md5.end();
...
exports.RequestChainResponse = RequestChainResponse;
...
class RequestChain {
    constructor(config, interceptor) {
        ...
        this.memoryCache = new cache_1.MemoryCache();
    }
